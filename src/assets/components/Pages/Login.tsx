      ...
      <div className="flex flex-col gap-[42px]">
        ...
        <form className="h-[154px] flex flex-col gap-[6px]">
          <section className="flex flex-col h-[70px] font-poppins">
            ...
            <input type="text" id="email" placeholder="enter your email" className="h-[45px] py-[6px] px-[10px] rounded text-[14px] leading-5 font-normal mt-[6px] border border-[#CCCCCC] placeholder:text-[#CCCCCC] focus:outline-none focus:ring-1 focus:ring-blue-500"/>
          ...
          <section className="flex flex-col h-[70px] font-poppins">
            ...
            <input type="password" id="password" placeholder="password" className="h-[45px] py-[6px] px-[10px] rounded text-[14px] leading-5 font-normal mt-[6px] border border-[#CCCCCC] placeholder:text-[#CCCCCC] focus:outline-none focus:ring-1 focus:ring-blue-500"/>
            <span className="h-[15px] text-[12px] font-normal text-red-600 px-[10px] mt-[-3px]"></span>
          </section>
        </form>
